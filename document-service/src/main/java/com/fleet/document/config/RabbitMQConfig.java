...
public class RabbitMQConfig {
    ...
    @Bean
    public Queue documentEventsQueue() {
        return new Queue("document.events", true);
    }
    ...
    @Bean
    public Binding documentEventsBinding() {
        return BindingBuilder.bind(documentEventsQueue())
                .to(fleetExchange())
                .with("document.*");
    }
